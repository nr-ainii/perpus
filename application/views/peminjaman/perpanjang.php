...
<?php foreach ($transaksi as $tr) : ?>
    <form method="POST" action="<?php echo base_url('peminjaman/perpanjang_aksi') ?>" enctype="multipart/form-data">
        <div class="container-fluid">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                                ...
                                <div class="col-sm-6">
                                        <label class="col-lg-9 ">Tanggal Perpanjang</label>
                                            <div class="col-lg-9">
                                                <input type="date" id="tgl_kembali" name="tgl_kembali" class="form-control"><br>
                                            </div>
